...
// ---- 防御カード ---------------------------------------------------
// 通常のカードとは別枠。山札には入らず、攻撃を受けた側がいつでも
// (何枚でも、コストが払える限り何度でも)使って被ダメージを
// block ぶんだけ軽減できる。script.js の canUseDefenseCard / useDefenseCard
// から参照される。
const CARDS_DEFENSE = [
  {
    "id": "guard",
...
const CARDS_BY_ID = new Map(
  [...ALL_CARDS, ...CARDS_DEFENSE].map((card) => [card.id, card])
);
